...
async function autoInicioProducts() {
    ...
    try {
        const url = 'http://150.136.105.81:8080/api/peripherals/all'
        // console.log(url)
...
async function consultarProduct(price, reference) {
    ...
    try {
        ...
        // debugger
        const url = 'http://150.136.105.81:8080/api/peripherals/' + reference
        // console.log(url)
        const response = await fetch(url);
...
async function createProduct() {
    ...
    if ($("#reference").val().length == 0 ||
        ...
        try {
            debugger
            let availability;
            const urlUpdate = 'http://150.136.105.81:8080/api/peripherals/new'
...
async function updateProduct() {
    if ($("#referenceU").val().length == 0 ||
        ...
        try {
            ...
            const urlUpdate = 'http://150.136.105.81:8080/api/peripherals/update'
...
async function deleteProduct(price, reference) {
    ...
    try {
        ...
        const urlUpdate = 'http://150.136.105.81:8080/api/peripherals/' + reference
