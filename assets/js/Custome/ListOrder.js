...
async function autoInicioOrdenes() {
  try {
    const url = 'http://150.136.105.81:8080/api/order/zona/' + sessionStorage.getItem('zona')
...
async function consultOrder(id) {
  ...
  try {
    ...
    // debugger
    const url = 'http://150.136.105.81:8080/api/order/' + id
    // console.log(url)
    const response = await fetch(url);
...
async function updateOrder(id) {
    ...
    try {
      const urlUpdate = 'http://150.136.105.81:8080/api/order/update'
